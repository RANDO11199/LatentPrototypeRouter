...
@dataclass
class BaseModelOutputWithPast_withTk(BaseModelOutputWithPast):
    
    topk_indices: Optional[Tuple[torch.FloatTensor, ...]] = None
...
class DeepseekV3Model(DeepseekV3PreTrainedModel):
    ...
    def forward(
        ...
        **flash_attn_kwargs: Unpack[FlashAttentionKwargs],
    ) -> BaseModelOutputWithPast_withTk:
        ...
        for decoder_layer in self.layers[: self.config.num_hidden_layers]:
            ...
            all_topk_indices += (layer_outputs[-1],)
        ...
        return BaseModelOutputWithPast_withTk(
...
@dataclass
class CausalLMOutputWithPastWithTopK(CausalLMOutputWithPast):
    topk_indices: Optional[Tuple[torch.FloatTensor, ...]] = None
...
class DeepseekV3ForCausalLM(DeepseekV3PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[KwargsForCausalLM],
    ) -> CausalLMOutputWithPastWithTopK:
        r"""
        ...
        return CausalLMOutputWithPastWithTopK(
            loss=loss,
            logits=logits,
...
__all__ = ["DeepseekV3PreTrainedModel", 
